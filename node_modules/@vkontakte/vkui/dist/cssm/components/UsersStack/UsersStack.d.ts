 ...
 */
export declare const UsersStack: ({ photos, visibleCount, count, size, layout, children, className, direction: directionProp, ...restProps }: UsersStackProps) => React.JSX.Element;
