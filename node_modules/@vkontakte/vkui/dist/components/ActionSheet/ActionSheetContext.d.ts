...
export type ItemClickHandler<T extends Element = Element> = (action: ActionType<T> | undefined, immediateAction: ActionType<T> | undefined, autoClose: boolean) => (event: React.MouseEvent) => void;
